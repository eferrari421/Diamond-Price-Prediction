...
diamond_norm_train = pd.DataFrame(preprocessing.normalize(train_x[['carat','depth','x','y','z','table', 'volume', 'ratio']]),columns=['carat','depth','x','y','z','table', 'volume', 'ratio'],index=train_x.index)
diamond_norm_test = pd.DataFrame(preprocessing.normalize(test_x[['carat','depth','x','y','z','table', 'volume', 'ratio']]),columns=['carat','depth','x','y','z','table', 'volume', 'ratio'],index=test_x.index)
train_x[['carat','depth','x','y','z','table', 'volume', 'ratio']] = diamond_norm_train[['carat','depth','x','y','z','table', 'volume', 'ratio']]
test_x[['carat','depth','x','y','z','table', 'volume', 'ratio']] = diamond_norm_test[['carat','depth','x','y','z','table', 'volume', 'ratio']]
